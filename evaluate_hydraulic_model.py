...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a saved hydraulic model on sensor data.")
    parser.add_argument(
        "--target",
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="Fraction of data to reserve for testing when not using full data.",
    )
    parser.add_argument(
        "--random-seed",
        type=int,
